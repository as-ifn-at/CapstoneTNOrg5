...
func main() {
	...
	txn, err := contract.CreateTransaction(
		"InitLedger",
		gateway.WithEndorsingPeers("peer0.org1.chaincart.com:7051", "peer0.org2.chaincart.com:9051", "peer0.org3.chaincart.com:11051", "peer0.org4.chaincart.com:13051"),
		// gateway.WithEndorsingPeers("peer0.org1.chaincart.com:7051"),
	)
	if err != nil {
